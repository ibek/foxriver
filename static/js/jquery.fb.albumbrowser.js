                    ...
                    success: function (result) {
                        if (result.data.length > 0) {
                            ...
                            for (a = 0; a < result.data.length; a++) {
                                ...
                                var photoThumb = $("<img>", { style: "margin: auto;position: absolute;top: 0; left: 0; bottom: 0; right: 0;display:none;", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb", "data-src": albumImg.source, src: "" });
